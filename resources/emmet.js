...
var gg = function(value, start, end, noIndent) {    // (content, caretPos - abbr.length, caretPos);
//  var content = 'html:5>div'; // this.getContent(); // todo
//  var utils = require('utils');
...
//  } catch (e) {}
  return {
    text: value, //utils.replaceSubstring(content, value, start, end),
    selectStart: firstTabStop.start,
    selectStop: firstTabStop.end
  };
};
...
// console.log(JSON.stringify(job(abbr, caretPos)));

// usage
// ./test.js "html:5>div" 100